...
<div class="row">
    <div class="col-sm-6">
    <h2 class="mb-0 font-weight-bold">DAFTAR KATEGORI</h2>
    </div>
    <div class="col-sm-6">
    <div class="d-flex align-items-center justify-content-md-end">
        <div class="pr-1 mb-3 mr-2 mb-xl-0">
        <a href="{{route('add_category')}}" class="btn btn-sm btn-info btn-icon-text border" style="background-color: #4A75A4;"><i class="typcn typcn-plus mr-2"></i>Tambah Data</a>
        </div>
